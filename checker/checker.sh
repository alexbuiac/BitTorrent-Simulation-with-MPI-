...
function test1 {
	...
	cp tests/test1/* .
	correct=0
	run_timeout "mpirun -v --oversubscribe -np 4 ./tema2"
...
function test2 {
	...
	cp tests/test2/* .
	correct=0
	run_timeout "mpirun -v --oversubscribe -np 6 ./tema2"
...
function test3 {
	...
	cp tests/test3/* .
	correct=0
	run_timeout "mpirun -v --oversubscribe -np 5 ./tema2"
...
function test4 {
	...
	cp tests/test4/* .
	correct=0
	run_timeout "mpirun -v --oversubscribe -np 7 ./tema2"
	compare_files client3_file1 out1.txt
